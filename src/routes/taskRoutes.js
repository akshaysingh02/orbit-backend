...
import { validateAssignTask, validateCreateTask, validateTaskStatus, validateUpdateTask } from "../middlewares/validators/taskValidators.js"
...
router.patch("/:id/assign",validateUuidParam,validateAssignTask,assignTask)
